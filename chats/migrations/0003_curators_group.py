# Роль «Кураторы»: группа в БД с правом chats.curate_team_chats.
...
def create_curators(apps, schema_editor):
    ...
    permission, _ = Permission.objects.get_or_create(
        codename="curate_team_chats",
        content_type=content_type,
        defaults={"name": "Может быть куратором чата учебной группы"},
    )
...
class Migration(migrations.Migration):
    dependencies = [
        ("chats", "0002_alter_chat_options_message_updated"),
